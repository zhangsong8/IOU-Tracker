...
******************************************************************************/
struct listnode *
listnodeAdd (struct List *list, void *val)
{
...
*/
void
listnodeDelete (struct List *list, void *val)
{
	struct listnode *node;
...
listNew ()
{
	...
	newList = (struct List *)calloc(1, sizeof (struct List));
	if(newList!=NULL)
	{
		newList->head = NULL ;
		newList->tail = NULL ;
...
*/
void
listDeleteAllNode (struct List *list)
{
	struct listnode *node;
	struct listnode *next;
...
*/
void
listDeleteNode (struct List *list, struct listnode *node)
{
	if (node->prev)
		node->prev->next = node->next;
	else
